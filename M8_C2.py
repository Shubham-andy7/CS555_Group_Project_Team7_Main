...
class TestUS3BirthBeforeDeath(unittest.TestCase):
    ...
    def test_US19_1(self):
        Error19 = US19_First_Cousin_should_not_marry(self.family9, self.individuals9)
        self.assertEqual(Error19, [])

    def test_US20_1(self):
        Error20 = US20_Aunts_and_uncles(self.family9, self.individuals9)
        self.assertEqual(Error20, [])
