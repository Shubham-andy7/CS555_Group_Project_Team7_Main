...
class TestUS3BirthBeforeDeath(unittest.TestCase):
    def setUp(self):
        ...
        self.family10 = {'F1': {'id': 'F1', 'Husband ID': 'I1', 'Husband Name': 'Allen', 'Husband Lastname': 'Roberts', 'Wife ID': 'I2', 'Wife Name': 'Julie', 'Wife Lastname': 'Jefferson', 'Married': '2012-10-08', 'Divorced': 'NA', 'Children': ['I3', 'I4']},'F2': {'id': 'F1', 'Husband ID': 'I1', 'Husband Name': 'Allen', 'Husband Lastname': 'Roberts', 'Wife ID': 'I4', 'Wife Name': 'Honey', 'Wife Lastname': 'Jefferson', 'Married': '2012-10-08', 'Divorced': 'NA', 'Children': ['I3', 'I4']}}
    ...
    def test_US25_1(self):
        Error25 = US25_Unique_first_names_in_families(self.family10, self.individuals14)
        self.assertEqual(Error25, ['I3', 'I4'])
    ...
    def test_U32_1(self):
        Error32 = US32_List_Multiple_Births(self.family11, self.individuals15)
        self.assertEqual(Error32, {'2011-10-08': [{'id': 'I3', 'Name': 'Jenny /Jefferson/', 'Gender': 'F', 'Birthday': '2011-10-08', 'Death': '2019-02-11', 'Alive': 'False', 'Child': 'NA', 'Spouse': 'NA', 'Age': 73}, {'id': 'I3', 'Name': 'Jenny /Jefferson/', 'Gender': 'F', 'Birthday': '2011-10-08', 'Death': '2019-02-11', 'Alive': 'False', 'Child': 'NA', 'Spouse': 'NA', 'Age': 73}]})
